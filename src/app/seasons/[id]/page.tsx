...
export default async function SeasonPage({
  ...
  if (season.is_gauntlet) {
    ...
    const [rounds, bracketShape, leaderboard, playersById, ehogRatings, sabremetrics, matchRounds, matchKills, matchWeaponClassStats] = await Promise.all([
