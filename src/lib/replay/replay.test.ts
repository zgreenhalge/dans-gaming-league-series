...
test('killFeed: only kills within the recent window, newest first', () => {
  ...
  const r = round({
    events: [
      { type: 'kill', tick: 100, attackerId: 1, victimId: 2, assisterId: null, weapon: 'weapon_ak47', headshot: false, noscope: false, wallbang: false, blindKill: false, midair: false, attacker: { x: 0, y: 0 }, victim: { x: 1, y: 1 } },
      { type: 'kill', tick: 500, attackerId: 3, victimId: 4, assisterId: null, weapon: 'weapon_awp', headshot: true, noscope: false, wallbang: false, blindKill: false, midair: false, attacker: { x: 2, y: 2 }, victim: { x: 3, y: 3 } },
    ],
  });
...
test('tracers: fade from 1 to 0 across the tracer window, then disappear', () => {
  ...
  const r = round({
    events: [
      { type: 'kill', tick: 100, attackerId: 1, victimId: 2, assisterId: null, weapon: null, headshot: false, noscope: false, wallbang: false, blindKill: false, midair: false, attacker: { x: 0, y: 0 }, victim: { x: 10, y: 0 } },
    ],
  });
