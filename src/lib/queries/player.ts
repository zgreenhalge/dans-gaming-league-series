 ...
 *  identifier (MatchZy's live remote-log events, e.g.) rather than a DB-known roster. A dedicated
 *  filtered query rather than `getPlayersById()`'s whole-table read: that function's callers each run
