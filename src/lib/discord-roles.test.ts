 ...
 * (create/rename/delete/color), including the ops_errors observability retrofit — a real Discord API
 * failure must be visible in the admin console's Activity feed, not just a Vercel function log.
 *
