...
| `DISCORD_BOT_TOKEN` | Discord bot token — used only by `scripts/register-discord-commands.ts`; the interactions endpoint itself is verified by `DISCORD_PUBLIC_KEY`, not this token |
